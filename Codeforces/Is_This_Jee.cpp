...
double check (double b, double c, double x){
...
void Solve(){
    ...
    while (end - start > diff){
    	double m1 = start + (end - start) / 3.0;
    	double m2 = end - (end - start) / 3.0;

    	double f1 = check(b, c, m1);
    	double f2 = check(b, c, m2);
